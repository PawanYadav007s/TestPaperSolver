...
API_KEY = os.getenv('GEMINI_API_KEY', 'YOUR_API_KEY')  # Get API key from environment variable
...
def get_answer_from_gemini(question):
    ...
    api_url = f"https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=AIzaSyCLq-Y3NHVYGnpwjZx2yIbgl_LiHeYEmO4"
    ...
    data = {
        "contents": [{
            "parts": [{
                "text": f"""Provide a comprehensive academic answer to the following question. 
